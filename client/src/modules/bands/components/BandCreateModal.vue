      ...
      <form class="modal-card__body" @submit.prevent="$emit('submit')">
        <div class="row g-3">
          <div class="col-12 col-md-6">
            ...
            <input :value="modelValue.name" class="form-control" @input="update('name', $event.target.value)" />
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label">{{ genreLabel }}</label>
            <input :value="modelValue.mainGenre" class="form-control" @input="update('mainGenre', $event.target.value)" />
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label">{{ cityLabel }}</label>
            <input :value="modelValue.baseCity" class="form-control" @input="update('baseCity', $event.target.value)" />
          </div>
          <div class="col-12 col-md-6">
            <ImageUploadField
