...
public record SearchResultSpaceRef(
  Long id,
  String name,
  ...
  public static SearchResultSpaceRef from(MusicalSpace musicalSpace, BigDecimal estimatedPrice) {
    return from(musicalSpace, estimatedPrice, null);
  }

  public static SearchResultSpaceRef from(
    MusicalSpace musicalSpace,
    BigDecimal estimatedPrice,
    SpaceReviewRatingStats ratingStats
  ) {
    return new SearchResultSpaceRef(
      musicalSpace.getId(),
